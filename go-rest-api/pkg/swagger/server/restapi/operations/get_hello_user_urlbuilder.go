...
func (o *GetHelloUserURL) Build() (*url.URL, error) {
	...
	if user != "" {
		...
		return nil, errors.New("user is required on GetHelloUserURL")
	}
...
func (o *GetHelloUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHelloUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHelloUserURL")
	}
